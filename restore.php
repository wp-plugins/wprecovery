...
$qry = "select * from $ocrb_backup order by id desc limit 8,1";
...
<div class="row ">
 ...
 <p class="alert-info col-md-12" style="padding:15px;">You cannot rollback right now. Rollback will become activated once you make any changes to the site.</p>
